...
describe NylasV2::API do
  ...
  describe "#contact_groups" do
    it "returns NylasV2::Collection for contact groups" do
  ...
  describe "#free_busy" do
    it "returns `NylasV2::FreeBusyCollection` for free busy details" do
  ...
  describe "application details" do
    it "gets the application details" do
      ...
      expect(app_details).to be_a(NylasV2::ApplicationDetail)
    ...
    it "updates the application details" do
      ...
      app_details = NylasV2::ApplicationDetail.new
      ...
      expect(updated_app_details).to be_a(NylasV2::ApplicationDetail)
    end
  end
